...
const FEATURES = [
  { icon: <Package size={24} />, title: 'Package Consolidation', description: 'Combine up to 10 packages into one shipment and save up to 80% on shipping costs.', color: '#1B4FD8', bg: 'bg-blue-50' },
  ...
  { icon: <Zap size={24} />, title: 'Fast Delivery', description: 'Express shipping options to 220+ countries. Arrive in as little as 3-5 business days.', color: '#F59E0B', bg: 'bg-amber-50' },
  ...
  { icon: <RotateCcw size={24} />, title: 'Easy Returns', description: 'We handle returns on your behalf. Send items back to US stores without any hassle.', color: '#38BDF8', bg: 'bg-sky-50' },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {FEATURES.map((feature, i) => (
            ...
            >
              ...
              <h3 className="font-bold text-[#0A1628] text-base mb-2">{feature.title}</h3>

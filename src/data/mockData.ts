...
export const BRANDS: Brand[] = [
  ...
  { id: '4',  name: 'Puma',      logo: 'https://logo.clearbit.com/puma.com',      category: 'Sportswear',     productsCount: 3800,    popularProducts: ['Velocity Nitro', 'RS-X', 'Future Rider'],     shippingEstimate: '8-14 days', description: 'Forever Faster',           color: '#E31837' },
...
export const PRODUCTS: Product[] = [
  ...
  { id: '4',  name: 'Puma Velocity Nitro 2',          brand: 'Puma',     category: 'Sportswear',    price: 169,  originalPrice: 200,  discount: 15, rating: 4.6, reviews: 842,  image: 'https://images.unsplash.com/photo-1608231387042-66d1773070a5?w=400&h=400&fit=crop&auto=format', description: 'Nitrogen-infused foam cushioning for explosive speed and comfort.',  inStock: true, tags: ['new'],            shippingEstimate: '8-14 days',  weight: 0.7  },

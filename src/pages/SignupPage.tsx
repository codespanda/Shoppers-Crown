    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-[#001A66] to-slate-900 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-5xl grid lg:grid-cols-2 gap-12 items-center">
        ...
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="hidden lg:block">
          ...
          <p className="text-slate-400 mb-8">Join millions of international shoppers who use Shoppers Crown to access their favorite US brands.</p>
          ...
          <div className="glass rounded-3xl p-8 shadow-2xl">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <label className="flex items-start gap-2 cursor-pointer">
                <input type="checkbox" className="rounded accent-[#1B4FD8] mt-0.5" {...register('terms')} />
                <span className="text-sm text-slate-600">
                  I agree to the{' '}
                  <Link to="/terms" className="text-[#1B4FD8] hover:underline">Terms of Service</Link>
                  {' '}and{' '}
                  <Link to="/privacy-policy" className="text-[#1B4FD8] hover:underline">Privacy Policy</Link>
                </span>
              </label>
